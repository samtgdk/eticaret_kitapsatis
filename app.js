    ...
    <div class="row book__card">
      ...
      <div class="col-6 d-flex flex-column justify-content-between">
        ...
        <div>
         ...
         ${
           book.oldPrice
             ? ` <span class="fw-bold fs-4 old__price">75</span>`
             : ""
         }
        </div>
        <button class="btn__purple" onclick="addBookBasket(${
          book.id
        })">add basket</button>
      </div>
    </div>
  ...
  if (findedBook) {
    ...
    if (basketAlreadyIndex == -1) {
      ...
      if (
        ...
        toastr.error("sorry , we dont have enough stock");
        return;
      }
    }
    listBasketItems();
